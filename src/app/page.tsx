    ...
    <main>
      ...
      <section className="h-[90vh] w-full rounded-md flex sm:items-center md:justify-center bg-black/[0.96] antialiased bg-grid-white/[0.02] relative overflow-hidden">
        ...
        <div className="p-4 max-w-7xl mx-auto w-full pt-20 md:pt-0">
          <h1 className="font-jakarta  sm:text-2xl lg:text-6xl font-semibold text-center text-white">
          ...
          <p className="sm:mt-2 md:mt-5 font-medium font-outfit sm:text-base lg:text-xl text-gray-300 max-w-lg text-center mx-auto">
